...
#define	NPY_VLEN		NCL_vlen
#define NPY_ENUM		NCL_enum
#define NPY_OPAQUE		NCL_opaque
#define NPY_COMPOUND	NCL_compound
#define NPY_REFERENCE	NCL_reference
#define NPY_LIST		NCL_list
#define NPY_LISTARRAY	NCL_listarray
